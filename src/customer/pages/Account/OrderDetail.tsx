    ...
    <Box className="space-y-5">
        <section className='flex flex-col gap-5 justify-center items-center'>
            ...
            <div className='text-sm space-y-1 text-center'>
                <h1 className='font-bold uppercase'>{order.orderItem?.product.seller?.bussinessDetails.businessName}</h1>
        ...
        <div className='border space-y-4'>
            <div className='flex justify-between text-sm pt-5 px-5'>
                <div className='space-y-1'>
                    ...
                    <p>You save <span className='text-green-500 font-medium text-xs'>{}</span>on this item</p>
                </div>
                <p className='font-medium'>{order.orderItem?.sellingPrice}VND</p>
            </div>
            <div className='px-5'>
            ...
            <div className='px-5 pb-5'>
                <p className='text-xs'><strong>Sold by: </strong>{order.orderItem?.product.seller?.bussinessDetails.businessName}</p>
            </div>
            <div className='p-10'>
                <Button 
